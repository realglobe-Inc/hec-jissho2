...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var count = __webpack_require__(31);
	var actions = Object.assign({}, count);
	...
	var Counter = (function (_super) {
	    ...
	    Counter.prototype.render = function () {
	        ...
	        return (React.createElement("div", null,
	            React.createElement("input", { type: 'button', onClick: function () { _this.props.dispatch(actions_1.default.incrementCount()); }, value: 'Button' }),
	            React.createElement("div", null,
	                "Counter: ",
	                this.props.storeState.count)));
	    };
	    return Counter;
	}(React.Component));
	var mapStateToProps = function (storeState) { return ({ storeState: storeState }); };
	var mapDispatchToProps = function (dispatch) { return ({ dispatch: dispatch }); };
	var CounterContainer = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(Counter);
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	document.addEventListener('DOMContentLoaded', function () {
	    ReactDOM.render(React.createElement(react_redux_1.Provider, { store: store_1.default },
	        React.createElement("div", null,
	            ...
	            React.createElement(counter_1.default, null))), rootElement);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var middlewares = [];
	var store = redux_1.createStore(reducers_1.default, redux_1.compose(redux_1.applyMiddleware.apply(void 0, middlewares)));
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var redux_1 = __webpack_require__(3);
	var count_1 = __webpack_require__(36);
